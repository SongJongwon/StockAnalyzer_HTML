...
const LANG = {
    ko: {
        ...
        tab_panel: '투자자 패널',
        panel_tab_title: '투자자 패널 토론',
        panel_tab_caption: '전설적 투자자 페르소나들이 토론을 통해 합의된 추천 종목을 제시합니다.',
        panel_query_label: '질문 또는 섹터',
        panel_query_placeholder: '예: 2026년 AI 반도체 섹터에서 장기 투자할 만한 종목은?',
        panel_personas_label: '참여 투자자 선택',
        panel_personas_hint: '(2명 이상 권장)',
        panel_loading_personas: '페르소나 목록 불러오는 중...',
        panel_max_rounds: '최대 라운드',
        panel_threshold: '수렴 임계값',
        panel_start_btn: '토론 시작',
        panel_api_hint: '※ 상단 우측 메뉴에서 AI API 키를 먼저 등록해주세요. Gemini 무료 키만 있어도 작동합니다.',
        panel_no_keys: '먼저 AI API 키를 등록해주세요. 상단 우측 ⋮ 메뉴 → AI API 설정.',
        panel_no_query: '질문을 입력해주세요.',
        panel_no_personas: '참여 투자자를 1명 이상 선택해주세요.',
        panel_running: '토론 진행 중... (30초~1분 소요)',
        panel_error: '토론 실행 실패',
        panel_report_title: '최종 리포트',
        panel_meta_rounds: '라운드',
        panel_meta_time: '소요 시간',
        panel_meta_tokens: '총 토큰',
        panel_meta_termination: '종료 사유',
        panel_consensus: '강력 추천 (합의)',
        panel_disputed: '논쟁 (찬반 갈림)',
        panel_orphan: '개별 관점 (단독 추천)',
        panel_round1: 'Round 1 · 개별 분석',
        panel_round_critique: '크로스 비판',
        panel_round_moderator: '중재자 집계',
        panel_convergence: '수렴 점수',
        panel_none: '(해당 없음)',
        panel_support: '지지',
        panel_for: '찬성',
        panel_against: '반대',
    ...
    en: {
        ...
        tab_panel: 'Investor Panel',
        panel_tab_title: 'Investor Panel Discussion',
        panel_tab_caption: 'Legendary investor personas debate and reach consensus on stock recommendations.',
        panel_query_label: 'Question or Sector',
        panel_query_placeholder: 'e.g., Which AI semiconductor stocks are worth long-term investment in 2026?',
        panel_personas_label: 'Select Investors',
        panel_personas_hint: '(2 or more recommended)',
        panel_loading_personas: 'Loading personas...',
        panel_max_rounds: 'Max Rounds',
        panel_threshold: 'Convergence Threshold',
        panel_start_btn: 'Start Discussion',
        panel_api_hint: '* Please register AI API keys from the top-right menu. Free Gemini key works fine.',
        panel_no_keys: 'Please register AI API keys first. Top-right menu (⋮) → AI API Settings.',
        panel_no_query: 'Please enter a question.',
        panel_no_personas: 'Please select at least 1 investor.',
        panel_running: 'Discussion in progress... (30s~1min)',
        panel_error: 'Discussion failed',
        panel_report_title: 'Final Report',
        panel_meta_rounds: 'Rounds',
        panel_meta_time: 'Duration',
        panel_meta_tokens: 'Total Tokens',
        panel_meta_termination: 'Termination',
        panel_consensus: 'Strong Recommendations (Consensus)',
        panel_disputed: 'Disputed (Pro vs Con)',
        panel_orphan: 'Individual Views (Solo)',
        panel_round1: 'Round 1 · Individual Analysis',
        panel_round_critique: 'Cross-Critique',
        panel_round_moderator: 'Moderator Synthesis',
        panel_convergence: 'Convergence Score',
        panel_none: '(none)',
        panel_support: 'Support',
        panel_for: 'For',
        panel_against: 'Against',
        panel_reason: 'Reason',
...
// (사전 + 헬퍼 함수는 js/kr-dict.js 로 이전 — 포트폴리오 모달 등에서 공유)
// ═══════════════════════════════════════════════

const KR_DICT       = window.NexusKrDict ? window.NexusKrDict.KR_DICT : [];
const getChosung    = (s) => window.NexusKrDict.getChosung(s);
const isChosungOnly = (s) => window.NexusKrDict.isChosungOnly(s);
const searchKrDict  = (q) => window.NexusKrDict.searchKrDict(q);
const resolveKrName = (q) => window.NexusKrDict.resolveKrName(q);
...
function setupTabs() {
    document.querySelectorAll('.tab').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            if (btn.dataset.tab === 'tab-panel' && typeof loadPanel === 'function') loadPanel();
        });
    });
}
